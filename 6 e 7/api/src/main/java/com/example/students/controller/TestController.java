...
public class TestController {
    ...
    @GetMapping("tests/maximum_grade")
    public ResponseEntity<Double> maximumGrade(){
        Double maximum_grade = Math.round(testService.maximunGrade() * 100.0)/100.0;
        return ResponseEntity.status(HttpStatus.OK).body(maximum_grade);
    }
